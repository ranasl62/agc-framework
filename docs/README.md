...
**Code layout:** see repository [README.md](../README.md) — `agc-core` is pure Java (`com.framework.agent.core`); `agc-spring-boot-starter` is the main consumer dependency; `agc-api` is the optional REST layer.
